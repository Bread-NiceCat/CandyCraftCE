...
public enum CArmorMaterials implements ArmorMaterial {
	...
	TRAMPOJELLY_BOOTS("trampojelly_boots", 10, new int[4], 8, SoundEvents.ARMOR_EQUIP_TURTLE, 0F, 0F, () -> Ingredient.of(/* todo CBlockEntries.JELLY_SHOCK_ABSORBER.getBlock()*/)),
	WATER_MASK("water_mask", 10, new int[4], 8, SoundEvents.ARMOR_EQUIP_TURTLE, 0F, 0F, () -> Ingredient.of(CItems.CRANFISH_SCALE.getItem())),

	LICORICE("licorice", 13, new int[]{1, 4, 5, 2}, 12, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, () -> Ingredient.of(CItemTags.LICORICE)),
	HONEYCOMB("honeycomb", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.of(CItemTags.HONEYCOMB)),
	PEZ("pez", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, () -> Ingredient.of(CItemTags.PEZ));
