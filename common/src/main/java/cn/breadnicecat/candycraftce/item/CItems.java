...
public class CItems {
	...
	public static final ItemEntry<Item> PEZ_DUST = create("pez_dust").setFood(10, 8f, p -> p.effect(new MobEffectInstance(MobEffects.NIGHT_VISION, (int) (60 * TickUtils.SEC2TICK)), 1F).fast().alwaysEat()).save();
