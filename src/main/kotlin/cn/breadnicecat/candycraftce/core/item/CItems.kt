...
import cn.breadnicecat.candycraftce.core.item.items.debugger.MarshmallowDebugger
...
object CItems {
    ...
    val honeycomb_torch = simple.sub(
        CBlocks.honeycomb_torch.id.path,
        {
            StandingAndWallBlockItem(
                CBlocks.honeycomb_torch.block,
                CBlocks.wall_honeycomb_torch.block,
                it,
                Direction.DOWN
            )
        })
...
//	/*工具*/
    private val sword = simple.sub("*sword", {
    ...
    private val shovel = simple.sub("*sword", {
    ...
    private val pickaxe = simple.sub("*sword", {
    ...
    private val axe = simple.sub("*sword", {
    ...
    private val hoe = simple.sub("*sword", {
    ...
    val marshmallow_debugger = simple.sub("marshmallow_debugger", factory = { MarshmallowDebugger(it) })
        .data {
