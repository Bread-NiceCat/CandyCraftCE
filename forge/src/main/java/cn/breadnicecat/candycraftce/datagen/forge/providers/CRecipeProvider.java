...
public class CRecipeProvider extends RecipeProvider {
	...
	private InventoryChangeTrigger.TriggerInstance has() {
		assertTrue(_used++ < 2, "abused");
		return _hasV;
	}
	
	private String hasn(ItemLike il) {
		return "has_" + ItemUtils.getKey(il.asItem()).getPath();
	}
	...
	private InventoryChangeTrigger.TriggerInstance _has2(Object o) {
