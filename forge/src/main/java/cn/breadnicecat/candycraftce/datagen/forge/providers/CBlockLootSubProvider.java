...
public class CBlockLootSubProvider extends BlockLootSubProvider {
	...
	protected void generate() {
		accept(m -> dropSelf(m.get()),
				...
				CHOCOLATE_BRICKS, BLACK_CHOCOLATE_BRICKS, WHITE_CHOCOLATE_BRICKS, CHOCOLATE_STONE_TILE,
				WHITE_CHOCOLATE_FURNACE, BLACK_CHOCOLATE_FURNACE, WHITE_CHOCOLATE_STONE_TILE, BLACK_CHOCOLATE_STONE_TILE
		);
